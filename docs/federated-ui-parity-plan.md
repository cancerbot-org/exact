...
*Prepared against the code as of 2026-09-09: EXACT `feat/4855-albumin-package` plus branch `2omop-federated-UI`, CB `ui.v2`, PROMOP `API_SURFACE.md`. The state-owner recommendation was cross-checked with codex.*
